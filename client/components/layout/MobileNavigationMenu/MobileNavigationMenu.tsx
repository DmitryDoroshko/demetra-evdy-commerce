...
export function MobileNavigationMenu({ active }: { active: boolean; }) {
  const pathname = usePathname();
  return (
    <div className={classNames(`header__mobile-nav`, { active })}>
      <nav className="header__dropdowns header__dropdowns--mobile">
        <ul className="header__dropdown-list header__dropdown-list--mobile">
          <li className="header__dropdown header__dropdown--mobile active">
            <Link href="/" className={classNames("header__link", "header__link--mobile", {
              active: pathname === "/",
            })}>Home</Link>
            <span className="header__drop-icon header__drop-icon--mobile"></span>
          </li>
          <li className="header__dropdown header__dropdown--mobile">
            <Link href="/shop" className={classNames("header__link", "header__link--mobile", {
              active: pathname === "/shop",
            })}>Shop</Link>
            <span className="header__drop-icon header__drop-icon--mobile"></span>
          </li>
          <li className="header__dropdown header__dropdown--mobile">
            <Link href="/product" className={classNames("header__link", "header__link--mobile", {
              active: pathname === "/product",
            })}>Product</Link>
            <span className="header__drop-icon header__drop-icon--mobile"></span>
          </li>
          <li className="header__dropdown header__dropdown--mobile">
            <Link href="/blog" className={classNames("header__link", "header__link--mobile", {
              active: pathname === "/blog",
            })}>Blog</Link>
            <span className="header__drop-icon header__drop-icon--mobile"></span>
          </li>
          <li className="header__dropdown header__dropdown--mobile">
            <Link href="/page" className={classNames("header__link", "header__link--mobile", {
      ...
      <ul className="header__actions header__actions--mobile">
        <li className="header__action">
          <button className="header__btn">
            <svg className="header__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="none"
                ...
                <g id="Header / Default">
                  ...
                  <g id="Frame 7">
                    <g id="search">
                      ...
                      <path id="Vector_2" d="M21 21L16.65 16.65" stroke="white" strokeWidth="2"
                            strokeLinecap="round"
        ...
        <li className="header__action">
          <Link href={"/sign-in"} className="header__btn">
            <svg className="header__icon" xmlns="http://www.w3.org/2000/svg" height="24"
        ...
        <li className="header__action">
          <Link href={"/wishlist"} className="header__btn">
            <svg className="header__icon" stroke="white" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
              <g id="heart">
                <path id="Vector"
