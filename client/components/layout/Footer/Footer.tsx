          ...
          <div className="footer__inner">
            ...
            <div className="footer__main">
              ...
              <div className="footer__col footer__col--1">
                ...
                <p className="footer__text-small">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
              ...
              <div className="footer__col footer__col--2">
                <div className="footer__heading footer__heading--red">Information</div>

                <div className="footer__links">
                  <a href="#" className="footer__link">About Evdy Commerce</a>
              ...
              <div className="footer__col footer__col--3">
                <div className="footer__heading footer__heading--red">Quick Links</div>

                <div className="footer__links">
                  <a href="#" className="footer__link">Wishlist</a>
                  <a href="#" className="footer__link">Checkout</a>
