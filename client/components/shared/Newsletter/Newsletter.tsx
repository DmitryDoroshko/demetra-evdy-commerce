        ...
        <div className="newsletter__inner">
          <div className="newsletter__left">
            ...
            <p className="newsletter__text">
              ...
              <span className="newsletter__text-highlighted">15% discount</span>{" "}
          ...
          <div className="newsletter__right">
            <form className="newsletter__form form">
              <input
                ...
                className="newsletter__input form__input"
              />
              <button
                className="newsletter__btn btn btn--red form__submit-btn"
                type="submit"
              >
                Subscribe
              </button>
