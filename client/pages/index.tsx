        ...
        <div className="container">
          <div className="our-products__inner">
            ...
            <main className="our-products__items">
              ...
              <div className="our-products__product-item">
                <img src="/assets/img/our-products/5.png" alt="5" className="our-products__img"/>
                  <div className="our-products__description">
                    <h3 className="our-products__brand">Nike</h3>
                    <h4 className="our-products__name">Zoom fly 5</h4>
                    <span className="our-products__price">$144</span>
                  </div>
                  <div className="our-products__actions">
                    <button className="our-products__btn btn btn--black">View product</button>
                  </div>
              ...
              <div className="our-products__product-item">
                <img src="/assets/img/our-products/6.png" alt="6" className="our-products__img"/>
                  <div className="our-products__description">
                    <h3 className="our-products__brand">Nike</h3>
                    <h4 className="our-products__name">air max plus</h4>
                    <span className="our-products__price">$189</span>
                  </div>
                  <div className="our-products__actions">
                    <button className="our-products__btn btn btn--black">View product</button>
                  </div>
              ...
              <div className="our-products__product-item">
                <img src="/assets/img/our-products/7.png" alt="7" className="our-products__img"/>
                  <div className="our-products__description">
                    <h3 className="our-products__brand">Converse</h3>
                    <h4 className="our-products__name">chuck 70 canvas</h4>
                    <span className="our-products__price">$90</span>
                  </div>
                  <div className="our-products__actions">
                    <button className="our-products__btn btn btn--black">View product</button>
                  </div>
              ...
              <div className="our-products__product-item">
                <img src="/assets/img/our-products/8.png" alt="8" className="our-products__img"/>
                  <div className="our-products__description">
                    <h3 className="our-products__brand">Jordan</h3>
                    <h4 className="our-products__name">air jordan 7 retro q </h4>
                    <span className="our-products__price">$194</span>
                  </div>
                  <div className="our-products__actions">
                    <button className="our-products__btn btn btn--black">View product</button>
                  </div>
